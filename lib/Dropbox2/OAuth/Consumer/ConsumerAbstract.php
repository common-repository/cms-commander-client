...
abstract class CMSC_Dropbox_OAuth_Consumer_ConsumerAbstract
{
	...
	*/
	...
	public function upgradeOAuth($access_token, $access_token_secret)
	{
		...
		$this->token = array();
		$this->token["oauth_token"] = $access_token;
		$this->token["oauth_token_secret"]  = $access_token_secret;
	...
	public function getAccessToken($code, $callback)
	{
        ...
        $url = CMSC_Dropbox_API::API_URL_V2 . self::ACCESS_TOKEN_METHOD;
		$params = array(
			'code' => $code,
